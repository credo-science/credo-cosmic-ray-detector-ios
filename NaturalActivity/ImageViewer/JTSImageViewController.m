...
- (void)viewDidLoadForImageMode {
    ...
    UIBarButtonItem* button = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemSave target:self action:@selector(saveButtonPressed:)];
    [toolbar setItems:@[button]];
    toolbar.opaque = NO;
    toolbar.barTintColor = [UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:0.0];
